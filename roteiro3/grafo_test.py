...
class TestGrafo(unittest.TestCase):
    ...
    def test_conexo(self):
        ...
        self.assertEqual(self.g_d.conexo(), True)
        self.assertEqual(self.nlw.conexo(), True)
        self.assertEqual(self.nlw_dfs_A.conexo(), True)
        self.assertEqual(self.nlw_dfs_K.conexo(), True)
        self.assertEqual(self.nlw_dfs_F.conexo(), True)
        self.assertEqual(self.nlw_dfs_C.conexo(), True)
        self.assertEqual(self.nlw_bfs_A.conexo(), True)
        self.assertEqual(self.nlw_bfs_K.conexo(), True)
        self.assertEqual(self.nlw_bfs_F.conexo(), True)
        self.assertEqual(self.nlw_bfs_C.conexo(), True)